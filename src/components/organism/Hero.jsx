...
const Hero = () => {
    return (
        <>
            <div className="w-full h-[28rem] md:mb-14 flex items-center justify-center relative">
                <BannerCarousel />
                <div className="absolute flex flex-col gap-6 items-center justify-center h-full w-full bg-black/25">
                    ...
                    <div className="flex absolute bottom-[-12%] shadow-md flex-col divide-y w-full max-w-2xl bg-white rounded-2xl md:border md:border-gray-200">

                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 w-full max-w-7xl mx-auto px-4 py-4 md:py-6 lg:py-8 xl:py-20">
                    <div className="flex flex-col space-y-4 md:space-y-6 w-full justify-center">
                        <div className="space-y-2 w-full">
                            ...
                            <h2 className="text-xl text-[#288ed2] font-semibold md:text-2xl lg:text-3xl">
                        ...
                        <div className="w-full space-x-4">
                            <Button variant="outline" className="border-[#288ed2]">Know More</Button>
                            <Button className="bg-[#288ed2]" >See Property Details</Button>
                        </div>
                    </div>
                    <div className="flex w-full">
